...
namespace Stock
{
    public partial class Products : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-0NB4I1N\\SQLEXPRESS;Initial Catalog=Stock;Integrated Security=True");
            //Insert Logic
            con.Open();
            bool status = false;
     ...
     VALUES ('" + textBox1.Text + "','" + textBox2.Text + "','" + status+ "')";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Sorry Record Not Exist....!");
            }            
            //Reading Data
            LoadData();
        }
